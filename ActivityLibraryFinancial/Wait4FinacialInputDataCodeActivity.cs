...
namespace ActivityLibraryFinancial
{
    ...
    public sealed class Wait4FinacialInputDataCodeActivity<T> : NativeActivity
    {
        // Define an activity input argument of type string
        public InArgument<string> BookMarkName { get; set; }
        public OutArgument<T> FinacialResult { get; set; }
        ...
        {
            context.SetValue(FinacialResult, (T)value);
        }
    }
}

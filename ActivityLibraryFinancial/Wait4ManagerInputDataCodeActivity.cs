...
namespace ActivityLibraryFinancial
{
    ...
    public sealed class Wait4ManagerInputDataCodeActivity <T>: NativeActivity
    {
        // Define an activity input argument of type string
        public InArgument<string> BookMarkName { get; set; }
        public OutArgument<T> ManagerResult { get; set; }
        ...
        {
            context.SetValue(ManagerResult, (T)value);
        }
    }
}
